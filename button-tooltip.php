	...
	jQuery(document).ready(function() {
		...
		var ButtonDialog = {
			...
			insert : function insertButton(ed) {
				...
				var content = jQuery('textarea[name=tooltip]').val();
	...
	<div id="button-dialog">
		<form id="button-form" action="/" method="get" accept-charset="utf-8">
			<div>
				...
				<textarea name="tooltip" id="tooltip" rows="3" cols="20"></textarea>
			</div>
			
			<div>
				<label for="text">Anchor Text (Leave blank if text is selected)</label>
				<input type="text" name="text" value="" id="text" />
			</div>
			
			<div>
                <label>Type</label>
                <input type="radio" name="type" value="classic" checked="checked">Classic
                <input type="radio" name="type" value="critical">Critical
                <input type="radio" name="type" value="help">Help
                <input type="radio" name="type" value="info">Info
                <input type="radio" name="type" value="warning">Warning
			</div>

            <div>
                <label for="title">Tooltip Title</label>
                <input type="text" name="title" value="" id="title" disabled="disabled" />
            </div>
